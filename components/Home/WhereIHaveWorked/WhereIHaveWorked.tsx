...
import Medikabazaar from "./Descriptions/Medikabazaar";
...
export default function WhereIHaveWorked() {
  ...
  const [DescriptionJob, setDescriptionJob] = React.useState("Medikabazaar");
  return (
    <div
      data-aos="fade-up"
      ...
      <div className="flex flex-col md:order-2 order-1 space-y-1 pl-8 md:pl-0 ">
        <div className="flex flex-row md:flex-col">
          <CompanyButton
            ...
            CompanyName="Medikabazaar"
            BarPosition={-12}
            BarAvobePosition={1}
            DescriptionJob="Medikabazaar"
            CompanyNameBackgroundColorGreen={[
              true,
              false,
              false,
